...
<body>
                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="poliklinik-umum">Poliklinik Umum</a></li>
                            <li><a class="dropdown-item" href="poliklinik-gigi">Poliklinik Gigi</a></li>
                            <li><a class="dropdown-item active-green" href="jadwal-dokter">Jadwal Dokter</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown px-3">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="row rounded shadow">
                                <div class="col-lg-6">
                                    <img src="../assets/img/dr/001-1.jpg" alt="" class="rounded size-jadwal-foto">
                                </div>
                                <div class="col-lg-6">
                                    <div class="py-3">
                        ...
                        <div class="swiper-slide">
                            <div class="row rounded shadow">
                                <div class="col-lg-6">
                                    <img src="../assets/img/dr/003-1.jpg" alt="" class="rounded size-jadwal-foto">
                                </div>
                                <div class="col-lg-6">
                                    <div class="py-3">
                        ...
                        <div class="swiper-slide">
                            <div class="row rounded shadow">
                                <div class="col-lg-6">
                                    <img src="../assets/img/dr/004-1.jpg" alt="" class="rounded size-jadwal-foto">
                                </div>
                                <div class="col-lg-6">
                                    <div class="py-3">
                        ...
                        <div class="swiper-slide">
                            <div class="row rounded shadow">
                                <div class="col-lg-6">
                                    <img src="../assets/img/dr/006-1.jpg" alt="" class="rounded size-jadwal-foto">
                                </div>
                                <div class="col-lg-6">
                                    <div class="py-3">
                        ...
                        <div class="swiper-slide">
                            <div class="row rounded shadow">
                                <div class="col-lg-6">
                                    <img src="../assets/img/dr/007-1.jpg" alt="" class="rounded size-jadwal-foto">
                                </div>
                                <div class="col-lg-6">
                                    <div class="py-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="py-3">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="../assets/img/dr/001-1.jpg" alt="" class="w-100 rounded">
                            </div>
    ...
    <!-- Modal -->
    <div class="modal modal-lg fade" id="staticBackdrop4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Jadwal Praktik RS Tonggak Husada</h1>
                ...
                <div class="modal-body">
                    <div class="py-3">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="../assets/img/dr/004-1.jpg" alt="" class="w-100 rounded">
                            </div>
                            <div class="col-md-6 py-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="py-3">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="../assets/img/dr/006-1.jpg" alt="" class="w-100 rounded">
                            </div>
                            <div class="col-md-6 py-1">
    ...
    <!-- Modal -->
    <div class="modal modal-lg fade" id="staticBackdrop7" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Jadwal Praktik RS Tonggak Husada</h1>
                ...
                <div class="modal-body">
                    <div class="py-3">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="../assets/img/dr/007-1.jpg" alt="" class="w-100 rounded">
                            </div>
                            <div class="col-md-6 py-1">
