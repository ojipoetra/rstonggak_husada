            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active-green" href="poliklinik-anak">Poliklinik Anak</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/poliklinik-anak.jpeg" class="img-fluid shadow rounded">
                <div class="col py-3">
