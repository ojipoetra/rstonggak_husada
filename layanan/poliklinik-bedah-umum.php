                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="poliklinik-bedah-umum">Poliklinik Bedah Umum</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/penyakit-dalam.jpeg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>POLIKLINIK BEDAH UMUM</h1>
                ...
                <div class="col">
                    <p>
                        Poliklinik Bedah Umum memberikan pelayanan kesehatan rawat jalan untuk pelayanan kesehatan dalam proses pembedahan umum. Pelayanan yang ditangi di Poliklinik Bedah Umum adalah Operasi Kecil, Perawatan luka biasa/luka oleh karena DM, Perawatan luka post Operasi Hernia, Usus Buntu, Haemoroid (wasir), Konsultasi seputar proses pembedahan, dan lain-lain.
                    </p>
                    <p>
                        Saat ini kami didukung oleh dokter-dokter spesialis bedah umum yang berpengalaman dibidangnya, serta ditunjang peralatan medis yang lengkap dan memadai untuk memberikan pelayanan bagi anda dan keluarga lebih optimal.
                    </p>
                </div>
            </div>
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="poliklinik-bedah-umum" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Poliklinik Bedah Umum</button></a>
