                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/ambulan">Ambulan</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <!-- <img src="../img/documention/ambulan.jpeg" class="img-fluid shadow rounded"> -->
                <div class="col py-3">
                    <h1>Ambulan</h1>
                    <h5>Layan Kami Tersedia Ambulan</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Ambulance merupakan kendaraan atau unit transportasi medis yang dilengkapi dengan peralatan medis untuk mengangkut, menangani pasien gawat darurat, memberikan pertolongan pertama dan melakukan perawatan intensif selama dalam perjalanan menuju rumah sakit rujukan.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="ambulan" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Ambulan</button></a>
