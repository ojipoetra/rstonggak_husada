                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/bersalin">Ruang Bersalin</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/ruang-bersalin.jpeg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>Ruangan Bersalin</h1>
                    <h5>Layan Kami Tersedia Ruangan Bersalin</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Ruang Bersalin ditunjang oleh tenaga dokter spesialis kandungan dan bidan yang profesional dengan pelayanan cepat dan ramah.
                        Ruang besalin juga dilengkapi dengan alat persalinan normal yang lengkap dan terbaru.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="bersalin" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Ruang Bersalin</button></a>
