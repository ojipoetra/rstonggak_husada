                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/farmasi">Instalasi Farmasi</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/farmasi.jpg" class="img-fluid shadow rounded">
                <div class="col py-3">
                ...
                <div class="col">
                    <p>
                        Instalasi Farmasi Rumah Sakit merupakan fasilitas penyelenggaraan kefarmasian dibawah pimpinan seorang Apoteker yang handal. Untuk mengadakan, menyediakan obat-obatan
                        yang lengkap dan berkualitas serta mengelola seluruh aspek penyediaan perbekalan kesehatan di Rumah Sakit. Instalasi RS Tonggak Husada beroprasi selama 24 jam, dapat memudahkan pasien
                        mendapatkan obat-obatan dan alat kesehatan yang dibutuhkan.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="farmasi" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Instalasi Farmasi</button></a>
