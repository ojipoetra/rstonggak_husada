                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/laboratorium">Laboratorium</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/laboratorium.jpg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>Laboratorium</h1>
                ...
                <div class="col">
                    <p>
                        Pelayanan Laboratorium salah satu penunjang medis di RS Tonggak Husada. Memiliki Laboratorium lengkap dengan didukung oleh tenaga yang handal, hasil
                        yang cepat, akurat dan siap melayani pasien 24 jam.
                    </p>
                </div>
            </div>
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="laboratorium" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Laboratorium</button></a>
