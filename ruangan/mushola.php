                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/mushola">Musholah</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <!--<img src="../img/documention/mushola.jpeg" class="img-fluid shadow rounded">-->
                <div class="col py-3">
                    <h1>Tersedia Mushola</h1>
                    <h5>Layan Kami Tersedia Mushola</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Layanan Rumah Sakit Tonggak Husada menyediakan tempat untuk beribadah seperti Mushola.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="mushola" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Mushola</button></a>
