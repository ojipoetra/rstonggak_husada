                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/operasi">Ruang Operasi</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/operasi.jpg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>Ruangan Operasi</h1>
                ...
                <div class="col">
                    <p>
                        Kamar Operasi atau ruangan operasi merupakan bagian dari pelayanan rumah sakit yang diperlukan untuk memberikan sarana dan prasarana tindakan bedah.
                        Layanan Bedah merupakan layanan unggulan di RS Tonggak Husada. RS Tonggak Husada memiliki tim bedah profesional yang terdiri dari dokte spesialis dan perawat yang berpengalaman
                        sehingga mampu dengan tanggap dan cepat mengangani setiap masalah dalam pembedahan.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="ugd" class="a-none"><button type="button" class="list-group-item list-group-item-action">UGD</button></a>
                    ...
                    <a href="operasi" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Ruang Operasi</button></a>
