                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/parkiran-dan-halaman-depan">Halaman Parkir dan Taman</a></li>
                        </ul>
                    </li>
                    <?php
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <!--<img src="../img/documention/parkiran3.jpeg" class="img-fluid shadow rounded">-->
                <div class="col py-3">
                    <h1>Tersedia Parkiran Luas dan Taman Depan</h1>
                    <h5>Layan Kami Tersedia Parkiran dan Taman</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Ruangan Parkiran dan Taman serta suasana yang sejuk, dimana halaman depan dan samping lahan perkiran yang sangat luas.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="parkiran-dan-halaman-depan" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Halaman Parkir dan Taman</button></a>
                </div>
            </div>
        </div>
    </div>
