                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/radiologi">Radiologi</a></li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/radiologi.jpeg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>Radiologi</h1>
                    <h5>Layan Kami Tersedia Ruangan Radiologi</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Radiologi merupakan instalasi penunjang medis yang memberikan layanan pemeriksaan untuk melihat bagian tubuh pasien dengan menggunakan "alat rogent".
                        Hasil pemerikasaan radiologi berupa foto yang dapat diperoleh seketika untuk membantu dokter mendiagnosis penyakit pasien. Sehingga dokter bisa memberikan
                        tindakan lebih cepat, tepat dan terbaik untuk kesembuhan pasien.
                    </p>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <a href="radiologi" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Radiologi</button></a>
