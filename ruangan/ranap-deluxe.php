                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active-green" href="../ruangan/ranap">Ruang Rawat Inap</a></li>
                            <li>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-9" data-aos="fade-up" data-aos-duration="1000">
                <img src="../assets/img/documention/ranap-deluxe.jpg" class="img-fluid shadow rounded">
                <div class="col py-3">
                    <h1>Ruangan Rawat Inap Deluxe</h1>
                    <h5>Layan Kami Tersedia Ruangan Rawat Inap Delux</h5>
                    <img src="../assets/img/logo-circle.png" class="rounded-circle shadow-lg"><b><span class="px-2">RS Tonggak Husada</span></b>
                    <hr>
                </div>
                <div class="col">
                    <p>
                        Rawat Inap RS Tonggak Husada memiliki berbagai berbagai kelas pilihan untuk pasien antara lain bangsal, kelas II, VIP dan Deluxe
                        untuk kelas Deluxe kami memberikan fasilitas :
                    <ol>
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-duration="1000">
                <div class="list-group">
                    ...
                    <!-- <a href="ranap" class="a-none"><button type="button" class="list-group-item list-group-item-action active-green">Ruang Rawat Inap</button></a> -->
                    <li class="active-green navbar-nav nav-item dropdown list-group-item list-group-item-action">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Ruang Rawat Inap
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="ranap-vip">VIP</a></li>
                            <li><a class="dropdown-item active-green" href="ranap-deluxe">Deluxe</a></li>
